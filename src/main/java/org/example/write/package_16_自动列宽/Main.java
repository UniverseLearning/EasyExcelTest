package org.example.write.package_16_自动列宽;
...
public class Main {
    public static void main(String[] args) {
        new Main().longestMatchColumnWidthWrite();
    }
    ...
    public void longestMatchColumnWidthWrite() {
        String fileName = PathUtil.currentResource("longestMatchColumnWidthWrite") + System.currentTimeMillis() + ".xlsx";
